...
- `core`: base agent, runtime interfaces, hosted Cloud Agent client SDK, flow descriptors, and profile/customization types. The package exposes an npm-ready `exports` map and README for external integrations.
